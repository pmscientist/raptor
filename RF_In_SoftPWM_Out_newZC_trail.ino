 ...
 *TRAILING Edge* SoftPWM SCR driver for the Raptor12

 DO NOT run this code when attached to inductive loads such as motors or transformers
 
 This may work better than leading edge dimming with capacitive loads, such as dimmable LED strings
...
void triggerOutputPin(){
  if (zeroCross) {
    ...
    //This will flip OFF any channels set to 0 at ZC
    ...
    //turn OFF channels if pwm value met
